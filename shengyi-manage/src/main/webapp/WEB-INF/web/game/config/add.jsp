...
<div class="content-box-header">
    <h3 style="cursor: s-resize;">增加配置</h3>
    <div class="clear"></div>
</div>
...
<div class="content-box-content">
    <form class="form-horizontal" action="add" method="post">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="key" name="key" placeholder="键" required pattern=".{1,}" value="${entity.key}" maxlength="45">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea class="input-xxlarge" name="value" rows="5" maxlength="355" required>${entity.value}</textarea>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <!-- 
                <textarea class="input-xxlarge" name="remark" rows="5">${entity.remark}</textarea>
                 -->
