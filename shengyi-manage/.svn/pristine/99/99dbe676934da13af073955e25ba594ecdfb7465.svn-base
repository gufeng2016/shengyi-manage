...
<body>
    ...
    <div class="content-box-content">
        <sp:form cssClass="form-horizontal" action="${ctx}/game/add" method="post" commandName="game">
           ...
           <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    　 			<sp:select cssClass="small-input text-input" path="status">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <button type="submit" class="btn button">增加游戏</button>
                </div>
            </div>
        </sp:form>
    </div>
