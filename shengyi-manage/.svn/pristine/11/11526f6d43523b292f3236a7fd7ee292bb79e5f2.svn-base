...
<body>
    <div class="content-box-header">
        <h3 style="cursor: s-resize;">编辑权限</h3>
        <div class="clear"></div>
    </div>
    <div class="content-box-content">
        <sp:form cssClass="form-horizontal" action="${ctx}/auth/update" method="post" commandName="auth">
            <sp:hidden path="authId" />
            <div class="control-group">
                <label class="control-label" > 权限名： </label>

                <div class="controls">
                    <sp:input cssClass="small-input text-input" path="authName" size="20"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <sp:textarea cols="10" rows="10" path="authDesc"/>
